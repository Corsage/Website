  ...
  return (
    <div className="w-full my-10 mx-6 sm:mx-0">
      <div className="flex justify-center">
        <div className="relative flex flex-col lg:flex-row lg:self-start lg:items-center text-white">
          <div className="hidden lg:flex self-start absolute top-0 left-0">
            <span className="w-0.5 h-40 bg-accent" />
            <span className="w-40 h-0.5 bg-accent" />
          </div>

          <div className="relative flex items-center justify-center lg:ml-10 lg:mt-10 ">
            <StaticImage
              height={375}
              aspectRatio={1 / 1}
          ...
          <span className="hidden lg:block w-60 h-0.5 -ml-10 mt-5 bg-white z-10" />
                ...
                {aboutIndex === 0 && (
                  <>
                    <p className="mb-2">
                      ...
                      interest in reverse engineering, malware analysis, and
                      data mining.
                    </p>

                    <p>
                      Professionally, building innovative products or finding
                      optimized solutions drives my passion to code. My
                      interests include but are not limited to health care,
                      fashion, and gaming.
                    </p>
                  </>
                )}
                ...
                {aboutIndex === 1 && (
                  <>
                    ...
                    <p>
                      ...
                      MongoDB, MySQL, Linux, Pandas, React Native, React.js,
                      SciPy
                    </p>
                  </>
                )}
